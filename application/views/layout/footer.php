...
<footer class="sticky-footer">
    <div class="container my-auto">
        <div class="copyright text-center my-auto">
            <span>Copyright © SIS11A 2019</span>
        </div>
    </div>
</footer>
...
<script src="<?php echo base_url("recursos/vendor/datatables/jquery.dataTables.js");?>"></script>
<script src="<?php echo base_url("recursos/vendor/datatables/dataTables.bootstrap4.js");?>"></script>
